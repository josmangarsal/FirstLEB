...
PSIMPLEX NewSimplex(INT NDim, INT NVertex, PPREAL ppCoor, INT NSimplex) {
	...
	pS = (PSIMPLEX) GetMem((SIZE) 1, (SIZE) sizeof(SIMPLEX), "NewSimplex");
	pS->ppV = (PPVERTEX) GetMem((SIZE) NVertex, (SIZE) sizeof(PVERTEX), "NewSimplex->ppV");
	pS->pDistV = (PREAL) GetMem((SIZE) NDist, (SIZE) sizeof(REAL), "NewSimplex->pDistV");
	pS->pMaxDV = (PREAL) GetMem((SIZE) NVertex, (SIZE) sizeof(REAL), "NewSimplex->pMaxDV");
...
PSIMPLEX CopySimplex(PSIMPLEX pSO, INT NDim, INT NVertex, INT NDist) {
	...
	pSD = (PSIMPLEX) GetMem((SIZE) 1, (SIZE) sizeof(SIMPLEX), "CopySimplex:pSD");
	pSD->ppV = (PPVERTEX) GetMem((SIZE) NVertex, (SIZE) sizeof(PVERTEX), "CopySimplex: pSD->ppV");
	pSD->pDistV = (PREAL) GetMem((SIZE) NDist, (SIZE) sizeof(REAL), "CopySimplex: pSD->pDistV");
	pSD->pMaxDV = (PREAL) GetMem((SIZE) NVertex, (SIZE) sizeof(REAL), "CopySimplex: pSD->pMaxDV");
