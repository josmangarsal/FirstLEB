...
/*---------------------------------------------------------------------------*/
PSIMPLEX NewSimplex (INT NDim, INT NVertex, PPREAL ppCoor, PBTV pbtv, INT NSimplex)
{
 int NumberOfDist[]={0,0,1,3,6,10,15,21,28,36,45,55,66,78,91,105,120};
 PSIMPLEX pS;
 INT i,NDist;
 ...
 for (i=0;i<NVertex;i++)
     {
      ...
      /*%%%%%%%%%%%%%%%%%%*/
      InsertBTV(pbtv, NDim, ppCoor[i], &AddVertex);
     }
...
/*---------------------------------------------------------------------------*/
VOID DivideSimplex(PPSIMPLEX ppS, PPSIMPLEX ppS1, INT NDim, PBTV pbtv)
{
 int NumberOfDist[]={0,0,1,3,6,10,15,21,28,36,45,55,66,78,91,105,120};
 ...
 /*%%%%%%%%%%%%%%%%%%*/
 InsertBTV(pbtv, NDim, pRV, &AddVertex);
